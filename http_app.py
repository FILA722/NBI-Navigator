...
def write_mac():
    if request.method == 'POST':
        print('write mac Post method started')
        ...
        ans = write_mac_address(saved_mac_addresses,
                                ...
                                client_vlan,
                                client_name)
        print('write mac Post method ended')
